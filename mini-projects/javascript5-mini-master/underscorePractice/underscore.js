...
var emails = customers.map(e=> e.email);
var _emails = _.pluck(customers, "email");
...
var noDups = _.union(inviteList1, inviteList2);
  ...
  var mutual = friendsOfJim.filter(e => friendsOfBetty.indexOf(e) !== -1)

  var _mutual = _.intersection(friendsOfBetty, friendsOfJim);
...
var _groupBy = _.groupBy(purchases, "company")
